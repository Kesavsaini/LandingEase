...
const faqArray=[
    ...
    { question: "How do I publish my landing page?", answer: "After customizing your page, click the 'Publish' button. Your page will be deployed instantly on a unique subdomain." },
